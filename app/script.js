const rawPrompts = [
  ...
  { word: "電池切れ", reading: "でんちぎれ", mood: "panic" },
  { word: "無音既読", reading: "むおんきどく", mood: "quiet" },
  { word: "通知多すぎ", reading: "つうちおおすぎ", mood: "panic" },
  { word: "給料日", reading: "きゅうりょうび", mood: "money" },
  { word: "重力二倍", reading: "じゅうりょくにばい", mood: "heavy" },
  { word: "花金爆発", reading: "はなきんばくはつ", mood: "happy" },
  { word: "電車遅延", reading: "でんしゃちえん", mood: "glitch" },
  { word: "記憶が薄い", reading: "きおくがうすい", mood: "faint" },
  { word: "お腹すいた", reading: "おなかすいた", mood: "hungry" },
  { word: "眠すぎる", reading: "ねむすぎる", mood: "sleep" },
  { word: "あと五分", reading: "あとごふん", mood: "sleep" },
  { word: "推しが光る", reading: "おしがひかる", mood: "shine" },
  { word: "神対応", reading: "かみたいおう", mood: "shine" },
  { word: "そよ風", reading: "そよかぜ", mood: "float" },
  { word: "ハート連打", reading: "はーとれんだ", mood: "pop" },
  { word: "共感爆発", reading: "きょうかんばくはつ", mood: "burst" },
  { word: "最高発光", reading: "さいこうはっこう", mood: "shine" },
  { word: "安心オーラ", reading: "あんしんおーら", mood: "calm" },
  ...
  { word: "氷メンタル", reading: "こおりめんたる", mood: "ice" },
  ...
  { word: "余裕の風", reading: "よゆうのかぜ", mood: "float" },
  ...
  { word: "謎オーラ", reading: "なぞおーら", mood: "shine" },
  ...
  { word: "光る世界", reading: "ひかるせかい", mood: "shine" },
  ...
  { word: "ポップ連打", reading: "ぽっぷれんだ", mood: "pop" },
...
function setMood(mood) {
  ...
  document.body.classList.remove("mood-snap");
  void document.body.offsetWidth;
  document.body.classList.add("mood-snap");
}
